...
# ---------------------------
    ...
    my @styles = (
                  { descr  => "Google look-a-like",
                    author => "Koos Pol <koos_pol\@raketnet.nl" ,
                    style  => <<EOT
table.my_tab   { border-bottom: solid thin #C0D4E6; text-align: center }
...
EOT
                  ...
                  { descr  => "Dark green-light green, heavy rule",
                    ...
                    style  => <<EOT
a  { color: #aa00ff }
table.my_tab     { border-bottom: medium solid #6FA579; margin-bottom: 6px }
...
EOT
                  ...
                  { descr  => "Light purple-dark purple, heavy rule",
                    ...
                    style  => <<EOT
a  { color: White }
table.my_tab     { border-bottom: medium solid #8b0a50; margin-bottom: 6px }
...
EOT
                  ...
                  { descr  => "Light purple-grey, heavy rule",
                    ...
                    style  => <<EOT
a  { color: White }
table.my_tab     { border-bottom: medium solid #cf0f76; margin-bottom: 6px }
...
EOT
                  ...
                  { descr  => "Brown-blue, heavy rule",
                    ...
                    style  => <<EOT
a  { color: White }
table.my_tab     { border-bottom: medium solid #00688b; margin-bottom: 6px }
...
EOT
                  ...
                  { descr  => "Bold font-light font, dark blue, heavy rule",
                    ...
                    style  => <<EOT
a  { color: Yellow }
table.my_tab     { border-bottom: medium solid #000080; margin-bottom: 6px }
...
EOT
                  ...
                  { descr  => "Red frame, grey, thin rule",
                    ...
                    style  => <<EOT
a  { color: Black }
table.my_tab     { border-bottom: thin solid Grey; margin-bottom: 6px }
...
EOT
                  ...
                  { descr  => "Red top line,  grey, thin rule",
                    ...
                    style  => <<EOT
a  { color: Black }
table.my_tab     { border-bottom: thin solid #bebebe; margin-bottom: 6px }
td.my_tab_actv   { padding: 2 15 2 15; background-color: #bebebe; text-align: center; font-weight: bold ; border-top: medium solid red }
td.my_tab        { padding: 2 15 2 15; background-color: #bebebe; text-align: center; font-weight: bold }
...
EOT
                  ...
                  { descr  => "Blue underline, grey underline",
                    ...
                    style  => <<EOT
a  { color: Black }
table.my_tab     { margin-bottom: 6px }
